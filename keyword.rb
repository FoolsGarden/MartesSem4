class ContactInformation
  ...
  def initialize(nombre:, telefono:, celular:, email:, referencia:, colonia:, municipio:, ciudad:, estado:, codigo_postal:, calle:, num_ext:, num_int: , pais:,  mayor_de_edad:)
    @nombre = nombre
    @telefono = telefono
    @celular = celular
    @email = email
